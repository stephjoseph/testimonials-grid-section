...
export default function Testimonials() {
  return (
    <div className="grid gap-6">
      <div className="relative flex h-[27.75rem] w-full flex-col gap-[1.125rem] rounded-[8px] bg-[#733FC8] px-8 pt-[1.625rem] pb-8 shadow-[40px_60px_50px_-47px_rgba(72,85,106,0.2474)]">
        <div className="absolute top-0 left-[12.438rem] h-[6.375rem] w-[6.5rem]">
        ...
        <div className="z-10 flex flex-col gap-10">
          ...
          <p className="text-medium w-[15.438rem] text-[0.813rem] leading-[1.125rem] tracking-normal text-[#CFCFCF]/70">
      ...
      <div className="flex h-[15rem] w-full flex-col gap-[1.125rem] rounded-[8px] bg-[#48556A] px-8 pt-[1.625rem] pb-8 shadow-[40px_60px_50px_-47px_rgba(72,85,106,0.2474)]">
        <div className="z-10 flex items-center gap-[1.063rem]  ">
      ...
      <div className="flex h-[13.875rem] w-full flex-col gap-[1.125rem] rounded-[8px] bg-white px-8 pt-[1.625rem] pb-8 shadow-[40px_60px_50px_-47px_rgba(72,85,106,0.2474)]">
        <div className="z-10 flex items-center gap-[1.063rem]  ">
          <div className="h-[1.75rem] w-[1.75rem] rounded-full ">
            <img
              className="h-[1.75rem] w-[1.75rem] rounded-full"
      ...
      <div className="flex h-[24rem] w-full flex-col gap-[1.125rem] rounded-[8px] bg-[#19202D] px-8 pt-[1.625rem] pb-8 shadow-[40px_60px_50px_-47px_rgba(72,85,106,0.2474)]">
        <div className="z-10 flex items-center gap-[1.063rem]  ">
      ...
      <div className="flex h-[27.375rem] w-full flex-col gap-[1.125rem] rounded-[8px] bg-white px-8 pt-[1.625rem] pb-8 shadow-[40px_60px_50px_-47px_rgba(72,85,106,0.2474)]">
        <div className="z-10 flex items-center gap-[1.063rem]  ">
          <div className="h-[1.75rem] w-[1.75rem] rounded-full ">
            <img
              className="h-[1.75rem] w-[1.75rem] rounded-full"
